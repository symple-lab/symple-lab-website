  ...
  useEffect(() => {
    ...
    if (stored) {
      try {
        ...
        const journals = data.filter(p => p.type === "Journal").sort((a, b) => b.year - a.year);
        setPublications(journals);
      ...
      <div className="min-h-screen bg-white pt-20">
        <section className="py-16">
          <div className="container max-w-4xl">
            <h1 className="text-4xl font-bold text-foreground mb-4">Journal Papers</h1>
            <p className="text-lg text-muted-foreground mb-12">Journal publications</p>
            <div className="text-center py-12">
              <p className="text-muted-foreground">No journal papers loaded yet.</p>
      ...
      <section className="py-16">
        <div className="container max-w-4xl">
          ...
          <p className="text-lg text-muted-foreground mb-12">
            {publications.length} journal publications
          </p>
